                ...
                @auth
                    <x-slot:actions>
                        <x-form wire:submit="logout">
                            <x-button label="Logout" icon="o-arrow-left-start-on-rectangle" spinner="logout" type="submit" />
                        </x-form>
                    </x-slot:actions>
                @endauth
            </x-header>
